...
import { getCompanyHealthStatus, getLowestInventory, type Company, type ProductInventory } from "@/lib/data";
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      ...
                      <p className="text-xs text-gray-400">{company.plan ? `${company.plan} · ` : ""}{company.integration || company.customerType.join(", ")}</p>
                    </td>
